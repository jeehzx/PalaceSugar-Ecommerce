...
export default async function SearchPage({
  ...
  return (
    <div className="grid md:grid-cols-5 md:gap-5 mt-4">
      <details className="dropdown">
        <summary className="btn m-1">Department</summary>
      ...
      <details className="dropdown mt-2">
        <summary className="btn m-1">Price</summary>
      ...
      <details className="dropdown">
        <summary className="btn m-1">Customer Review</summary>
        <ul className="menu dropdown-content bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
          <li>
            <Link
